...
public class TargetTags : MonoBehaviour
{
    ...
    public List<AttackTypeTag> damageableTypeTags;
    ...
    {
        return damageableTypeTags.Contains(t);
    }
    public bool HasDamageableTypeTag(string tagname)
    {
        return damageableTypeTags.Exists(t => t.Name.Equals(tagname, System.StringComparison.InvariantCultureIgnoreCase));
    }
    public bool ContainsAllDamageableTypeTags(List<AttackTypeTag> checkingTags)
    {
        return new HashSet<AttackTypeTag>(damageableTypeTags).IsSupersetOf(new HashSet<AttackTypeTag>(checkingTags));
    }
